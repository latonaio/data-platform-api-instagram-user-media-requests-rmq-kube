...
type Message struct {
	InstagramUserMediaResponse *[]InstagramUserMediaResponse `json:"InstagramUserMediaResponse"`
}

type InstagramUserMediaResponseBody struct {
	ID       			string  `json:"id"`
...
type InstagramUserMediaResponse struct {
